...
export default function PatientEditPage() {
  ...
  const updatePatientMutation = useMutation({
    ...
    onError: (error) => {
      ...
      setErrors({ submit: 'Erro ao atualizar paciente. Tente novamente.' })
    },
    onSettled: () => {
    ...
    return (
      <div style={{ 
        ...
        <div style={{ 
          ...
          <h2 style={{ margin: '0', color: '#1f2937' }}>Carregando dados do paciente...</h2>
        </div>
      </div>
    )
  }
    ...
    return (
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ fontSize: '48px', marginBottom: '16px' }}>❌</div>
          <h2 style={{ margin: '0 0 16px 0', color: '#dc2626' }}>Erro ao carregar paciente</h2>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
            ...
            <button
              ...
              style={{
                padding: '12px 32px',
                background: isSubmitting ? '#9ca3af' : 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)',
                color: 'white',
                border: 'none',
                borderRadius: '8px',
            ...
            >
              {isSubmitting ? '⏳ Atualizando...' : '✏️ Atualizar Paciente'}
            </button>
          </div>
        </div>
